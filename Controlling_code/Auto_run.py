...
def analyze_data_to_stop(data,step_index,time_interval=50,interval_threshold=200):
    ...
    while running:
        ...
        if current_time - last_analyzed_time < 5:
            ...
            if step_index >= 10:
                ...
                should_continue = analyze_data_to_stop(data['AU1'], step_index)
                print(f"Result of analyze_data_to_stop: {should_continue}")
...
def auto_column(condition):
    if condition == 'case1':
        ...
        send_sample_command('0', 25, '000500', port4)
